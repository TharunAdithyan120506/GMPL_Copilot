  ...
  return (
    <div className="p-4 md:p-margin flex flex-col gap-margin relative overflow-y-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-12 gap-bento-gap">
        ...
        <div className="col-span-1 md:col-span-3 bg-tertiary-fixed border-2 border-on-background neo-shadow p-4 md:p-6 flex flex-col justify-between">
          <div className="flex justify-between items-start mb-3 md:mb-4">
            <span className="font-label-sm text-label-sm uppercase text-on-tertiary-container">Pending Edits</span>
            <span className="material-symbols-outlined text-tertiary fill-icon">edit_document</span>
          </div>
          <div className="font-data-lg text-[36px] md:text-[48px] leading-none text-on-tertiary-container font-bold">{kpis.pendingEdits}</div>
          <div className="mt-3 md:mt-4">
            <span className="bg-tertiary text-on-tertiary px-2 py-1 font-label-sm text-[11px] uppercase border border-on-background inline-block">Needs Review</span>
          </div>
        </div>
        ...
        <div className="col-span-1 md:col-span-3 bg-surface-container-low border-2 border-on-background neo-shadow p-4 md:p-6 flex flex-col justify-between">
          <div className="flex justify-between items-start mb-3 md:mb-4">
            <span className="font-label-sm text-label-sm uppercase text-on-surface-variant">Near Life Limit</span>
            <span className="material-symbols-outlined text-warning fill-icon">timer</span>
          </div>
          <div className="font-data-lg text-[36px] md:text-[48px] leading-none text-on-background font-bold">{kpis.nearLimitMoulds}</div>
          <div className="mt-3 md:mt-4 flex flex-col gap-2">
            ...
            <span className="font-label-sm text-[11px] text-on-surface-variant">{nearLimitPercent}% over 90% life</span>
          </div>
        </div>
              ...
              <div key={log.id} className="px-5 py-3 flex items-center justify-between">
                <div>
                  <p className="font-data-md font-bold text-on-background">
                    {log.mould?.code || 'Mould'} — {new Date(log.logDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'short' })}
                  </p>
                  <p className="font-body-md text-sm text-on-surface-variant">
