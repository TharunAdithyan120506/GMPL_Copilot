...
router.get('/', (0, auth_middleware_1.authorize)('rawmaterial.view'), async (req, res) => {
    try {
...
router.post('/', (0, auth_middleware_1.authorize)('rawmaterial.create'), async (req, res) => {
    try {
...
router.patch('/:id', (0, auth_middleware_1.authorize)('rawmaterial.update'), async (req, res) => {
    try {
...
router.delete('/:id', (0, auth_middleware_1.authorize)('rawmaterial.delete'), async (req, res) => {
    try {
